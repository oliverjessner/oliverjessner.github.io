...
permalink: '/pinefetch/'
description: 'PineFetch is a minimal desktop app for downloading your own videos with queueing, TXT link imports, Magic Import, History, presets, and optional audio extraction — powered by yt-dlp.'
meta_description: 'PineFetch is a minimal desktop downloader for your own videos, with queueing, TXT link imports, Magic Import, History, presets, optional audio extraction, and yt-dlp power.'
meta_title: 'PineFetch | Minimal Video Downloader Desktop App'
