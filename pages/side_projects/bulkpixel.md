...
hero:
    ...
    lead: 'BulkPixel handles repetitive image work with a quieter desktop workflow. Export to PNG, JPEG, and WEBP, change resolution across multiple files, and move on.'
    ...
    caption: 'One focused desktop view for conversion, resizing, and export.'
    meta:
        - 'Bulk conversion'
        - 'Batch resize'
        - 'PNG, JPEG, WEBP'
...
features_intro:
    ...
    heading: 'A small set of tools for repetitive image work.'
...
features:
    ...
    - title: 'Export cleanly'
      description: 'Write out PNG, JPEG, or WEBP depending on the job.'
...
faq:
    ...
    - question: 'Which formats can BulkPixel export?'
      answer: 'BulkPixel can export images to PNG, JPEG, and WEBP depending on the job.'
...
cta:
    ...
    text: 'Download the app, inspect the code, and use it when you need bulk image conversion without the clutter.'
