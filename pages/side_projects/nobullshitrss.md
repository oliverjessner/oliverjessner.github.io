...
meta_description: 'Download NO-BULLSHIT-RSS, a free open-source desktop RSS reader for macOS, Windows and Linux with chronological feeds, local topics, grouped digests and a read-only CLI.'
...
software_application:
    ...
    release_url: 'https://github.com/oliverjessner/NO-BULLSHIT-RSS/releases/tag/v1.0.2'
    macOS_url: 'https://github.com/oliverjessner/NO-BULLSHIT-RSS/releases/download/v1.0.2/NO.BULLSHIT.RSS-1.0.2-arm64.dmg'
    linux_url: 'https://github.com/oliverjessner/NO-BULLSHIT-RSS/releases/download/v1.0.2/NO.BULLSHIT.RSS-1.0.2.AppImage'
    windows_url: 'https://github.com/oliverjessner/NO-BULLSHIT-RSS/releases/download/v1.0.2/NO.BULLSHIT.RSS.Setup.1.0.2.exe'
    price: '0'
    price_currency: 'EUR'
...
faq:
    ...
    - question: 'Can I use it from the terminal?'
      answer: 'Yes. The read-only CLI finds the existing app database and returns articles or digests as plain text or JSON.'
    - question: 'Which operating systems are supported?'
      answer: 'Version 1.0.0 provides downloads for macOS on Apple Silicon, Windows x64 and Linux x64.'
---
