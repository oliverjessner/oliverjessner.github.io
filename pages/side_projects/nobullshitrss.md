...
software_application:
    ...
    release_url: 'https://github.com/oliverjessner/NO-BULLSHIT-RSS/releases/tag/v1.0.0'
    macOS_url: 'https://github.com/oliverjessner/NO-BULLSHIT-RSS/releases/download/v1.0.0/NO.BULLSHIT.RSS-1.0.0-arm64.dmg'
    linux_url: 'https://github.com/oliverjessner/NO-BULLSHIT-RSS/releases/download/v1.0.0/NO.BULLSHIT.RSS-1.0.0.AppImage'
    windows_url: 'https://github.com/oliverjessner/NO-BULLSHIT-RSS/releases/download/v1.0.0/NO.BULLSHIT.RSS.Setup.1.0.0.exe'
    price: '0'
    price_currency: 'EUR'
