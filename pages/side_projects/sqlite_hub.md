...
feature_sections:
    ...
    - id: 'schema-types'
      ...
      eyebrow: '03 / Schema'
      title: 'Understand and change the schema'
      text: 'Inspect tables, indexes, relationships, and DDL. Design schema changes and generate application types from your database.'
      points:
