---
layout: post
title: 'Microsoft ersetzt OpenAI bei Bildern in PowerPoint und Bing'
date: 2026-07-23 19:52:18 +000
...
categories:
    ...
    - openai
    - KI
description: 'Microsoft setzt in Bing Image Creator und PowerPoint auf MAI-Image-2.5 und senkt damit Kosten, ohne OpenAI vollständig abzulösen'
thumbnail: '/assets/images/gen/blog/microsoft-ersetzt-openai-bei-bildern-in-powerpoint-und-bing/header_thumbnail.webp'
image: '/assets/images/gen/blog/microsoft-ersetzt-openai-bei-bildern-in-powerpoint-und-bing/header.webp'
image_width: 1280
image_height: 854
faq:
    - question: 'Welches OpenAI-Modell ersetzt Microsoft in PowerPoint?'
      answer: 'Microsoft setzt für Bildbearbeitungsfunktionen in PowerPoint MAI-Image-2.5 anstelle von GPT-Image-2 ein. Andere Copilot-Funktionen können weiterhin Modelle von OpenAI verwenden.'
    - question: 'Verwendet Bing Image Creator weiterhin OpenAI?'
      answer: 'MAI-Image-2.5 ist laut Microsoft das standardmäßige Modell für die gesamte Generierung und Bearbeitung in Bing Image Creator. Ob alternative Modelle weiterhin auswählbar bleiben, kann von Oberfläche und Rollout abhängen.'
    - question: 'Warum entwickelt Microsoft eigene KI-Modelle?'
      answer: 'Eigene Modelle geben Microsoft mehr Kontrolle über Kosten, Geschwindigkeit, Infrastruktur und Produktintegration. In PowerPoint sollen die GPU-Kosten dadurch um bis zu 84 Prozent sinken.'
socialmedia:
...
Über den Wechsel berichtete zunächst [Bloomberg](https://www.bloomberg.com/news/articles/2026-07-23/microsoft-replacing-openai-image-ai-models-in-powerpoint-bing). Parallel veröffentlichte Microsoft genauere Angaben zur technischen und wirtschaftlichen Seite der Umstellung.

Der Schritt ist Teil einer größeren Strategie. [Microsoft](https://oliverjessner.at/category/microsoft/) möchte nicht mehr für jede KI-Funktion auf Modelle externer Anbieter angewiesen sein. Das Unternehmen entwickelt deshalb eigene Modelle für Bilder, Sprache, Transkription, Programmierung und logisches Schlussfolgern.
...
Nach Angaben von [Microsoft AI](https://microsoft.ai/news/introducing-mai-image-2-5-pro-and-mai-voice-2-flash/) ist der Bing Image Creator inzwischen "100 Prozent in-house". MAI-Image-2.5 übernimmt als Standardmodell sowohl die Generierung neuer Bilder als auch die Bearbeitung bestehender Bilder.
...
Für diese Aufgaben verwendete Microsoft zuvor GPT-Image-2 von [OpenAI](https://oliverjessner.at/category/openai/). Durch den Wechsel zu MAI-Image-2.5 sollen die benötigten GPU-Kosten um bis zu 84 Prozent sinken.
...
Dass Microsoft eigene Modelle in PowerPoint und Bing einsetzt, bedeutet nicht, dass [OpenAI](https://oliverjessner.at/category/openai/) vollständig aus Microsofts Produkten verschwindet.
...
Die Umstellung bei den Bildfunktionen zeigt jedoch, dass Microsoft OpenAI nicht mehr automatisch als technische Grundlage jeder neuen [KI](https://oliverjessner.at/category/KI/)-Funktion betrachtet.
