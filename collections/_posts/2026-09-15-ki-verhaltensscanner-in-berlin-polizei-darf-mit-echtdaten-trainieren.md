---
layout: post
title: 'KI-Verhaltensscanner in Berlin: Polizei darf mit Echtdaten trainieren'
date: 2026-09-15 19:35:00 +0200
...
categories:
    ...
    - Gesellschaft
    - Politik
description: 'Berliner Verhaltensscanner dürfen unter Bedingungen mit personenbezogenen Echtdaten nachtrainiert werden. Was das ASOG konkret erlaubt'
thumbnail: '/assets/images/gen/blog/ki-verhaltensscanner-in-berlin-polizei-darf-mit-echtdaten-trainieren/header_thumbnail.webp'
image: '/assets/images/gen/blog/ki-verhaltensscanner-in-berlin-polizei-darf-mit-echtdaten-trainieren/header.webp'
image_width: 1280
image_height: 853
faq:
    - question: 'Darf die Berliner Polizei KI mit personenbezogenen Echtdaten trainieren?'
      answer: 'Ja. § 42d ASOG erlaubt unter bestimmten Voraussetzungen das Training und Testen von KI-Systemen mit personenbezogenen Daten, wenn Anonymisierung oder Pseudonymisierung den Zweck nicht erfüllen oder unverhältnismäßig aufwendig wären.'
    - question: 'Welche Unternehmen arbeiten an den Berliner Verhaltensscannern?'
      answer: 'Den Auftrag für die Infrastruktur erhielt laut netzpolitik.org Adesso SE. Das initiale KI-Modell für bestimmte Bewegungsmuster wurde nach Angaben des Berliner Senats von der Staige GmbH mit synthetischen Daten trainiert.'
    - question: 'Wo sollen die KI-Verhaltensscanner in Berlin eingesetzt werden?'
      answer: 'Die KI-gestützte Videoüberwachung ist zunächst für kriminalitätsbelastete Orte wie das Kottbusser Tor und die Warschauer Straße vorgesehen.'
socialmedia:
...
Eine [schriftliche Anfrage des Linken-Abgeordneten Niklas Schrader](https://cdn.netzpolitik.org/wp-upload/2026/09/S19-26879.pdf) zeigt nun genauer, welche Daten dabei verarbeitet werden und wie diese später für das Training der eingesetzten [KI](https://oliverjessner.at/category/ki/) genutzt werden können.
...
Für die [Privacy](https://oliverjessner.at/category/privacy/) ist das ein wesentlicher Unterschied zu einem System, das ausschließlich mit vollständig anonymisierten oder synthetischen Datensätzen arbeitet.
...
Wie [netzpolitik.org berichtet](https://netzpolitik.org/2026/ki-training-berliner-verhaltensscanner-sollen-privatfirmen-mit-echtdaten-fuettern/), erhielt Adesso SE den Auftrag für die KI-gestützte Überwachungsinfrastruktur. Das Unternehmen arbeitet im Bereich Videoanalyse unter anderem mit der Staige GmbH zusammen.
...
Gerade bei polizeilicher [Überwachung und Politik](https://oliverjessner.at/category/politik/) wird damit aus einer klassischen Datenschutzfrage zunehmend auch eine Frage darüber, wie staatliche KI-Systeme entstehen und wem die daraus entwickelte Technologie später nutzen kann.
