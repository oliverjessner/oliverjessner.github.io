...
faq:
    ...
    - question: 'Sollte ich nur Löschung verlangen oder auch Do Not Contact?'
      answer: 'Beides. Eine reine Löschung kann dazu führen, dass dein Profil später neu aufgebaut wird. Eine zusätzliche Kennzeichnung als Do Not Contact, Suppressed oder Opted Out ist oft praktischer.'
    - question: 'Welche Daten sollte ich in eine Anfrage aufnehmen?'
...
{% capture pr_cleanup_request_template %}
Hello,
...
{% include framework/blocks/components/copy-snippet.html
    title="PR-Löschanfrage zum Kopieren"
    description="Passe Name, E-Mail-Adresse und Standort an und kopiere das Template mit einem Klick."
    content=pr_cleanup_request_template
    language="text"
    button_label="Template kopieren"
    copied_label="Template kopiert"
    error_label="Erneut versuchen"
    success_message="Das Template liegt jetzt in deiner Zwischenablage."
    error_message="Kopieren fehlgeschlagen. Bitte markiere den Text manuell."
%}
...
Ich würde das Thema nicht emotional, sondern operativ angehen. Erst eine Grundreinigung mit einem Dienst wie [Incogni](https://incogni.cello.so/VgYLwipnqms). Danach die wichtigsten Medien-Datenbanken manuell anschreiben. Dann eine lokale Dokumentation anlegen, idealerweise mit Datum, Ansprechpartner, Status und Antwort.
