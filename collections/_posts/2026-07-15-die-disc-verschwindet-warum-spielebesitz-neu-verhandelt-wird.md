...
faq:
    ...
    - question: 'Was sind Game-Key Cards?'
      answer: 'Game-Key Cards sind physische Karten, die nicht das vollständige Spiel enthalten, sondern den Download und Start eines Spiels ermöglichen.'
    - question: 'Werden alte Spielesammlungen dadurch automatisch wertvoller?'
      answer: 'Nicht automatisch. Wert entsteht nur, wenn Nachfrage, Zustand, Seltenheit und tatsächliche Spielbarkeit zusammenkommen.'
socialmedia:
    - 'Physische Spiele verschwinden nicht einfach. Mit ihnen verändert sich, was Besitz im Gaming bedeutet: Weiterverkauf, Verleihen, Sammeln und Erhalt hängen plötzlich an Accounts und Servern.'
...
Physische Spiele waren lange selbstverständlich. Heute werden sie zur Ausnahme. Das verändert nicht nur Regale und Sammlungen, sondern auch die Frage, was wir bei Spielen eigentlich besitzen.
...
Bei [Nintendo](https://oliverjessner.at/category/nintendo/) Switch 2 gibt es sogenannte Game-Key Cards. Nintendo erklärt dazu, dass das eigentliche Spiel nicht vollständig auf der Karte liegt. Die Karte dient als Schlüssel. Beim ersten Start muss das Spiel heruntergeladen werden, danach bleibt die Karte zum Starten notwendig.
...
Sicher ist nur: Wenn physische Spiele verschwinden, verliert [Gesellschaft](https://oliverjessner.at/category/Gesellschaft/) nicht einfach Plastikboxen. Sie verliert eine Form von Besitz, die lange selbstverständlich war.
