---
layout: post
title: 'Firefox mit Mistral: Was Mozillas neuer KI-Browser kann'
date: 2026-09-17 12:40:00 +0200
...
description: 'Firefox integriert Mistral Small 4 in Smart Window. Was die KI-Funktion kann, wann sie nach Deutschland kommt und wie sie sich abschalten lässt'
thumbnail: '/assets/images/gen/blog/firefox-mit-mistral-was-mozillas-neuer-ki-browser-kann/header_thumbnail.webp'
image: '/assets/images/gen/blog/firefox-mit-mistral-was-mozillas-neuer-ki-browser-kann/header.webp'
image_width: 1280
image_height: 720
faq:
    - question: 'Welche KI verwendet Firefox für Smart Window?'
      answer: 'Mozilla integriert Mistral Small 4 in die Beta von Firefox Smart Window. Das Modell stammt vom französischen KI-Unternehmen Mistral AI und steht unter der Apache-2.0-Lizenz.'
    - question: 'Wann kommt Firefox Smart Window nach Deutschland?'
      answer: 'Smart Window ist derzeit in den USA, Kanada und Frankreich verfügbar. Deutschland und Großbritannien sollen laut Mistral noch im Laufe des Jahres 2026 folgen.'
    - question: 'Kann ich die KI-Funktionen in Firefox deaktivieren?'
      answer: 'Ja. Firefox bietet zentrale AI Controls. Darüber lassen sich einzelne KI-Funktionen oder sämtliche aktuellen und künftigen KI-Funktionen deaktivieren.'
socialmedia:
...
Mozilla erweitert [Firefox](https://oliverjessner.at/category/browser/) um weitere KI-Funktionen. Im Zentrum steht Firefox Smart Window, ein neuer Browsermodus, der derzeit noch als Beta getestet wird.
...
Das ist für Mozilla ein wichtiger Punkt. Browser werden zunehmend zu einer weiteren Zugriffsschicht auf generative [KI](https://oliverjessner.at/category/ki/). Wer Browser, Suchmaschine und KI-Modell gleichzeitig kontrolliert, kann entsprechend großen Einfluss darauf bekommen, wie Nutzer auf Informationen zugreifen.
...
Gerade aus Sicht von [Privacy](https://oliverjessner.at/category/privacy/) ist das wichtig. Sobald ein KI-Assistent Inhalte aus Tabs oder dem Browserverlauf verarbeitet, stellt sich automatisch die Frage, welche Daten dafür übertragen werden und welcher Anbieter sie verarbeitet.
...
- [Mozilla: Mozilla and Mistral partnering to expand AI competition and preserve user choice](https://blog.mozilla.org/en/firefox/mozilla-mistral-partnership/)
- [Mozilla: AI on your terms](https://blog.mozilla.org/en/firefox/firefox-ai-on-your-terms/)
- [Mistral AI: Mistral and Mozilla](https://mistral.ai/news/mistral-x-mozilla/)
