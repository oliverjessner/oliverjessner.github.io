---
layout: post
title: 'NEURA Robotics übernimmt ADLATUS: Physical AI für Reinigungsroboter'
...
description: 'NEURA Robotics übernimmt ADLATUS und baut sein Physical-AI-Ökosystem aus. Warum autonome Reinigungsroboter dabei strategisch wichtig sind'
thumbnail: '/assets/images/gen/blog/neura-robotics-uebernimmt-adlatus-physical-ai-fuer-reinigungsroboter/header_thumbnail.webp'
image: '/assets/images/gen/blog/neura-robotics-uebernimmt-adlatus-physical-ai-fuer-reinigungsroboter/header.webp'
image_width: 1280
image_height: 720
faq:
    - question: 'Was übernimmt NEURA Robotics von ADLATUS Robotics?'
      answer: 'NEURA Mobile Robots übernimmt 100 Prozent der ADLATUS Robotics GmbH aus Ulm. Damit kommen unter anderem autonome Reinigungsroboter, eigene Navigationssoftware und hunderte bereits installierte Systeme zur NEURA-Gruppe.'
    - question: 'Was bedeutet Physical AI bei Reinigungsrobotern?'
      answer: 'Physical AI soll Robotern ermöglichen, ihre physische Umgebung nicht nur zu erfassen, sondern Situationen zu interpretieren und ihr Verhalten daran anzupassen. NEURA will die ADLATUS-Systeme dafür mit zusätzlicher Sensorik und KI weiterentwickeln.'
    - question: 'Was passiert mit den ADLATUS-Reinigungsrobotern nach der Übernahme?'
      answer: 'Die Systeme sollen schrittweise technologisch erweitert und an das Neuraverse von NEURA angebunden werden. Langfristig plant NEURA außerdem die Integration in den eigenen Fleet Manager.'
socialmedia:
...
Der Begriff "Physical AI" wird inzwischen von mehreren Robotikunternehmen verwendet. Gemeint ist vereinfacht eine Form von [KI](https://oliverjessner.at/category/ki/), die nicht nur Texte, Bilder oder Daten verarbeitet, sondern mit der physischen Welt interagiert.

Ein Roboter muss dafür mehrere Schritte miteinander verbinden:

1. seine Umgebung mit Sensoren erfassen
2. relevante Objekte und Zustände erkennen
3. die aktuelle Situation interpretieren
4. eine geeignete Handlung auswählen
5. diese Handlung physisch ausführen
...
Für die [Softwareentwicklung](https://oliverjessner.at/category/software-development/) bedeutet das eine bekannte Herausforderung in neuer Form: Fähigkeiten sollen nicht jedes Mal vollständig für einen einzelnen Roboter implementiert werden, sondern möglichst zwischen unterschiedlichen Systemen nutzbar werden.
