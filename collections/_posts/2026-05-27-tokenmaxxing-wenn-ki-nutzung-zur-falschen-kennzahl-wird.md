...
faq:
    ...
    - question: 'Warum ist Ubers Beispiel relevant?'
      answer: 'Uber zeigt, dass hohe Nutzung von KI-Werkzeugen intern beeindruckend aussehen kann, aber erst dann sinnvoll ist, wenn sie klar mit besseren Funktionen, weniger Reibung oder messbarer Produktivität verbunden ist.'
    - question: 'Ist KI im Software Engineering damit gescheitert?'
      answer: 'Nein. Der Punkt ist nicht, dass KI unbrauchbar ist. Der Punkt ist, dass KI-Werkzeuge wie andere technische Systeme gesteuert, gemessen und wirtschaftlich bewertet werden müssen.'
---
...
Ausgangspunkt ist ein Bericht von [Tom's Hardware](https://www.tomshardware.com/tech-industry/artificial-intelligence/uber-chief-warns-no-link-yet-between-ai-tokenmaxxing-and-shipping-successful-products-company-pumps-the-brakes-on-all-out-ai-spending). Darin geht es um Aussagen von Andrew Macdonald, President und COO von Uber. Laut Bericht sieht Uber bisher keinen klaren Zusammenhang zwischen höherem KI-Verbrauch und nützlicheren Funktionen für Kundinnen und Kunden.
...
Gerade im Umfeld von [vibecoding](https://oliverjessner.at/category/vibecoding/) ist diese Unterscheidung wichtig. Es ist leicht, mit KI schnell sichtbare Ergebnisse zu erzeugen. Es ist schwerer, daraus robuste, wartbare und wirtschaftlich sinnvolle Software zu machen.
