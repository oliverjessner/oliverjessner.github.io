...
image_height: 853
faq:
    - question: 'Was ist Gemini 3.8 Flash?'
      answer: 'Gemini 3.8 Flash ist ein neues KI-Modell von Google für Softwareentwicklung, agentische Workflows und komplexe Aufgaben mit mehreren Arbeitsschritten.'
    - question: 'Was kostet Gemini 3.8 Flash?'
      answer: 'Bis Ende 2026 kostet Gemini 3.8 Flash 0,75 US-Dollar pro Million Input-Tokens und 3,75 US-Dollar pro Million Output-Tokens. Ab Januar 2027 steigen die Preise.'
    - question: 'Kann jeder Gemini 3.8 Flash Cyber verwenden?'
      answer: 'Nein. Gemini 3.8 Flash Cyber wird zunächst nur ausgewählten Behörden, Betreibern kritischer Infrastruktur und Software-Maintainern über Googles Fairwind-Programm angeboten.'
socialmedia:
...
| Modell                 | Schwerpunkt                            | Verfügbarkeit                        |
| ---------------------- | -------------------------------------- | ------------------------------------ |
| Gemini 3.8 Flash       | Coding, KI-Agenten, komplexe Workflows | Allgemein verfügbar                  |
| Gemini 3.8 Flash Cyber | Schwachstellenanalyse und Patching     | Eingeschränkter Zugang über Fairwind |
...
Gemini 3.8 Flash ist Googles neues Modell für allgemeine [KI](https://oliverjessner.at/category/ki/)-Anwendungen mit einem besonderen Schwerpunkt auf Softwareentwicklung und agentischen Workflows.
...
Ein Schwerpunkt liegt auf [Softwareentwicklung](https://oliverjessner.at/category/software-development/).
...
Das entspricht der Entwicklung, die derzeit generell im [Software Engineering](https://oliverjessner.at/category/software-engineering/) mit KI-Agenten zu beobachten ist. Statt einzelne Prompts zu beantworten, sollen Modelle zunehmend vollständige Arbeitsabläufe übernehmen.
...
| Nutzung                 |          Preis |
| ----------------------- | -------------: |
| 1 Million Input-Tokens  | 0,75 US-Dollar |
| 1 Million Output-Tokens | 3,75 US-Dollar |

Ab dem 1. Januar 2027 steigen die Preise auf:

| Nutzung                 |          Preis |
| ----------------------- | -------------: |
| 1 Million Input-Tokens  | 1,50 US-Dollar |
| 1 Million Output-Tokens | 7,50 US-Dollar |
