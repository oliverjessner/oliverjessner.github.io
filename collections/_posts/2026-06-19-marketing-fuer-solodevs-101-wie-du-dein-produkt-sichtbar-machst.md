---
layout: post
title: 'Was 0-Euro-Marketing für Solodevs und Side Projects leisten kann'
...
categories:
    ...
    - Social Media
    - self-improvement
description: 'Du hast ein Tool, eine App oder ein SaaS-Projekt gebaut, aber kein Budget für Ads oder PR? So machst du dein Produkt als Solodev mit 0 Euro Marketingbudget sichtbar, findest erste Nutzer und bekommst echtes Feedback.'
thumbnail: '/assets/images/gen/blog/marketing-fuer-solodevs-101-wie-du-dein-produkt-sichtbar-machst/header_thumbnail.webp'
image: '/assets/images/gen/blog/marketing-fuer-solodevs-101-wie-du-dein-produkt-sichtbar-machst/header.webp'
faq:
    - question: 'Wie startet man als Solodev mit Marketing ohne Budget?'
      answer: 'Der beste Start für Solodevs ist eine klare Positionierung: Definiere deine Zielgruppe, das konkrete Problem, das du löst, und deinen einzigartigen Mehrwert gegenüber Alternativen. Danach folgen eine verständliche Landingpage, Launch auf Plattformen wie Product Hunt oder Hacker News, aktive Teilnahme in relevanten Communities (Reddit, Twitter/X) und SEO durch Blog-Content. Wichtig: Konsistenz schlägt Budget – regelmäßige, authentische Kommunikation bringt mehr als einmalige Werbung.'
    - question: 'Welche Marketing-Kanäle eignen sich am besten für Solodevs und Side Projects?'
      answer: 'Für Solodevs ohne Budget eignen sich besonders: Launch-Plattformen (Product Hunt, Hacker News, DevHunt), Community-Plattformen (Reddit, Twitter/X, Threads, LinkedIn), SEO durch eigenen Blog und technische Inhalte, GitHub Awesome Lists und spezialisierte Tool-Verzeichnisse, sowie direktes Networking mit anderen Developern. Entscheidend ist nicht die Anzahl der Kanäle, sondern dass du dort präsent bist, wo deine Zielgruppe aktiv nach Lösungen sucht.'
    - question: 'Braucht man als Solodev ein Marketing-Budget für den Launch?'
      answer: 'Nein, ein großes Marketing-Budget ist für Solodevs am Anfang nicht notwendig. Organische Kanäle wie Launch-Plattformen, Community-Marketing, SEO, Content-Marketing und Networking reichen völlig aus, um erste Nutzer zu gewinnen. Wichtiger als Geld sind: eine klare Produktseite, verständliche Kommunikation, regelmäßige Sichtbarkeit und echtes User-Feedback. Bezahlte Werbung kann später sinnvoll sein, sollte aber nicht der erste Schritt sein.'
    - question: 'Wie viel Zeit sollte man als Solodev für Marketing einplanen?'
      answer: 'Als Solodev solltest du realistisch 20-30% deiner Zeit für Marketing einplanen – neben der eigentlichen Entwicklung. Das bedeutet: Lieber 2-3 Kanäle konsistent und qualitativ hochwertig bespielen als 8 Plattformen halbherzig. Tipp: Batch-Arbeit hilft – bereite Social-Media-Posts, Blog-Artikel und Launch-Materialien gebündelt vor, statt täglich neu zu starten.'

    - question: 'Wie bekommt man als Solodev die ersten 100 Nutzer?'
      answer: 'Die ersten 100 Nutzer gewinnst du durch: Launch auf Product Hunt, Hacker News oder DevHunt, gezielte Posts in passenden Subreddits (ohne plumpe Werbung), aktives Netzwerken mit anderen Solodevs, SEO-optimierte Blog-Artikel zu Problemen, die dein Tool löst, Einträge in GitHub Awesome Lists und Tool-Verzeichnisse, sowie direkte Ansprache in Communities, wo deine Zielgruppe nach Lösungen sucht. Wichtig: Biete echten Mehrwert und höre auf Feedback.'
socialmedia:
    - 'Als Solodev brauchst du kein Marketing-Budget. Mit Launch-Plattformen, Reddit, SEO und Community-Marketing erreichst du deine ersten Nutzer – komplett kostenlos. So geht 0-Euro-Marketing für Side Projects.'
    - 'Du hast ein Developer Tool gebaut, aber keine Nutzer? Das Problem: Die meisten Solodevs überspringen die Positionierung und starten sofort mit Werbung. Dabei beginnt erfolgreiches Marketing mit Klarheit, nicht mit Reichweite.'
    - 'Product Hunt, Hacker News, Reddit, GitHub Awesome Lists & Co.: Diese Launch-Plattformen helfen Solodevs, Side Projects und SaaS-Tools ohne Werbebudget sichtbar zu machen. Plus: Checkliste für deinen Launch.'
---
...
- _Optional_: ein GitHub-Repository
- _Optional_: Ein LinkedIn- und/oder Twitter/X-Profil
...
[Product Hunt](https://www.producthunt.com/) ist wahrscheinlich die bekannteste Plattform für Produkt-Launches. Besonders stark ist sie bei SaaS-Tools, Developer Tools, AI-Produkten, Design-Werkzeugen und kleinen digitalen Produkten.
...
[Hacker News](https://news.ycombinator.com/) ist keine klassische Launch-Plattform. Trotzdem kann ein guter "Show HN"-Post für technische Produkte sehr wertvoll sein.
...
[StackShare](https://stackshare.io/) ist besonders interessant, wenn ein Produkt als Teil eines technischen Stacks verstanden werden kann. Die Plattform ist weniger ein klassischer Launch-Ort und eher ein Verzeichnis für Tools, Technologien und Software-Stacks.
...
Dazu zählen zum Beispiel [DevHunt](https://devhunt.org/), [Hot100.ai](https://www.hot100.ai/builder/project/2078), [EarlyHunt](https://earlyhunt.com/), [OpenHunts](https://openhunts.com/), [PeerPush](https://peerpush.com/), [Findly.tools](https://findly.tools/), [LaunchDACH](https://launchdach.com/land/deutschland/), [SaaS Hub](https://saas-hub.de/), [Uneed](https://www.uneed.best/) und [Fazier](https://fazier.com/).

Achtung: Einige Launch-Seiten verlangen von dir, dass du solche hässlichen Badges auf deine Landingpage packst. Du kannst dir das bei [SQLite Hub](https://oliverjessner.at/sqlite-hub/) ansehen, ganz unten im Footer.
...
Gute Textplattform-Kommunikation fühlt sich weniger an wie ein Werbebanner und mehr wie ein Gespräch. Zeig, was dich am Problem gestört hat. Erzähl, welche Entscheidungen du beim Bau getroffen hast. Teile kleine Learnings, [Fehler](https://oliverjessner.at/blog/2024-11-07-5-gruende-warum-startups/), Screenshots, Vorher-nachher-Beispiele oder echte Use Cases. Je konkreter du wirst, desto eher verstehen andere Menschen, warum dein Produkt überhaupt existiert.
...
Wer irgendwann ein bisschen Traction bekommt, wird schnell merken: Sichtbarkeit zieht nicht nur Nutzer, Feedback und nette Nachrichten an, sondern auch Menschen mit sehr viel Meinung und sehr wenig Kontext. Neben hilfreichen Kommentaren gibt es fast immer auch [unbegründete Kritik](https://oliverjessner.at/blog/2026-06-17-der-linkedin-feed-ist-brainrot/), seltsame Seitenhiebe oder Menschen, die offenbar nur kurz vorbeischauen, um irgendwo schlechte Laune abzuladen.
...
Klassische Magazine und größere Tech-Websites wie t3n, [Golem.de](https://www.golem.de/search/?q=oliver%20jessner) oder vergleichbare Medien sind für Solodevs meistens kein guter erster Marketingkanal.
