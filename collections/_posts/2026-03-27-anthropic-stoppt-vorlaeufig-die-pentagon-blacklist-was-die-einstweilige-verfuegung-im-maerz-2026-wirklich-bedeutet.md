...
faq:
    - question: 'Was hat das Gericht genau entschieden?'
      answer: 'Eine Bundesrichterin stoppte am 26. März 2026 vorläufig die Einstufung von Anthropic als Lieferkettenrisiko und blockierte auch die Durchsetzung der Anweisung, alle Bundesbehörden sollten die Nutzung von Anthropic beenden.'
    - question: 'Warum kam es überhaupt zum Streit?'
      answer: 'Anthropic wollte laut eigener Darstellung zwei enge Grenzen nicht aufgeben: kein Einsatz für vollständig autonome Waffen und keine Massenüberwachung von Amerikanern. Daraus entstand der Konflikt mit dem US-Verteidigungsministerium.'
    - question: 'Ist der Fall damit schon entschieden?'
      answer: 'Nein. Es geht bisher um eine vorläufige gerichtliche Sicherung. Das ist ein wichtiger Zwischenschritt, aber noch kein endgültiges Urteil in der Sache.'
---

Der Sieg ist vorläufig, aber politisch hoch relevant. Wenn eine [KI](/category/ki/)-Firma das Pentagon per Gericht dazu zwingt, eine Blacklist zurückzunehmen, geht es nicht mehr nur um Anthropic, sondern um die Grenzen staatlicher Macht bei KI-Beschaffung.
...
- [Complaint PDF via Courthouse News](https://www.courthousenews.com/wp-content/uploads/2026/03/anthropic-supply-chain-risk-lawsuit.pdf)
