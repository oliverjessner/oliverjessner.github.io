---
layout: post
title: 'Quantenbatterie lädt in Billiardstelsekunden: Was dahinter steckt'
date: 2026-09-07 10:04:00 +0200
...
categories:
    ...
    - Bildung
    - Gesellschaft
description: 'Eine Quantenbatterie lädt im Femtosekundenbereich. Was hinter dem Rekord steckt, wie Superabsorption funktioniert und warum Handys warten müssen'
thumbnail: '/assets/images/gen/blog/quantenbatterie-laedt-in-billiardstelsekunden-was-dahinter-steckt/header_thumbnail.webp'
image: '/assets/images/gen/blog/quantenbatterie-laedt-in-billiardstelsekunden-was-dahinter-steckt/header.webp'
faq:
    - question: 'Was ist eine Quantenbatterie?'
      answer: 'Eine Quantenbatterie speichert Energie mithilfe quantenmechanischer Effekte. Der aktuelle Prototyp nutzt starke Licht-Materie-Kopplung in einer optischen Mikrokavität und kann aufgenommene Lichtenergie anschließend als elektrischen Strom abgeben.'
    - question: 'Lädt die Quantenbatterie wirklich in einer Billiardstelsekunde?'
      answer: 'Die beobachteten Ladeprozesse finden im Femtosekundenbereich statt. Eine Femtosekunde entspricht einer Billiardstelsekunde. Die Aussage beschreibt daher die Größenordnung und nicht, dass ein nutzbarer Smartphone-Akku exakt nach einer Femtosekunde voll wäre.'
    - question: 'Wann könnten Quantenbatterien in Smartphones oder Elektroautos eingesetzt werden?'
      answer: 'Dafür gibt es derzeit keinen absehbaren Termin. Der Prototyp speichert nur sehr kleine Energiemengen und hält seine Ladung lediglich einige Nanosekunden. Kurzfristig sind Anwendungen in spezieller Quantenhardware realistischer.'
socialmedia:
...
1. Licht gelangt in die optische Mikrokavität.
2. Die Photonen koppeln mit den Molekülen.
3. Dabei entstehen kollektive Licht-Materie-Zustände.
4. Das System nimmt Energie auf.
5. Die Energie wird in länger lebende angeregte Zustände übertragen.
6. Zusätzliche Schichten ermöglichen es, daraus einen elektrischen Strom zu erzeugen.
...
Für klassische [Computer-Hardware](https://oliverjessner.at/category/computer-stuff/), Smartphones oder Elektroautos ist das System in seiner aktuellen Form nicht geeignet.
...
Für die technische [Bildung](https://oliverjessner.at/category/Bildung/) ist diese Trennung zwischen experimentellem Nachweis und fertiger Anwendung mindestens genauso relevant wie der Rekord selbst.
