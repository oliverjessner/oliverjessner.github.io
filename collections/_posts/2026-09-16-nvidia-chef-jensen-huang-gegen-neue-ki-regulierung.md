---
layout: post
title: 'Nvidia-Chef Jensen Huang gegen neue KI-Regulierung'
date: 2026-09-16 09:20:00 +0200
...
categories:
    ...
    - Politik
description: 'Jensen Huang hält neue KI-Gesetze für unnötig. Der Nvidia-Chef setzt bei KI-Sicherheit auf Engineering, Marktmechanismen und bestehende Regeln'
thumbnail: '/assets/images/gen/blog/nvidia-chef-jensen-huang-gegen-neue-ki-regulierung/header_thumbnail.webp'
image: '/assets/images/gen/blog/nvidia-chef-jensen-huang-gegen-neue-ki-regulierung/header.webp'
image_width: 1280
image_height: 720
faq:
    - question: 'Was sagt Jensen Huang zur KI-Regulierung?'
      answer: 'Der Nvidia-Chef hält neue KI-Gesetze für unnötig und betrachtet KI-Sicherheit in erster Linie als technische Aufgabe.'
    - question: 'Warum lehnt Jensen Huang neue KI-Gesetze ab?'
      answer: 'Huang argumentiert, dass KI letztlich aus Software und Computersystemen besteht. Unternehmen, bestehende Regeln und Marktmechanismen sollen für Sicherheit sorgen.'
    - question: 'Will Jensen Huang auf KI-Sicherheit verzichten?'
      answer: 'Nein. Huang stellt KI-Sicherheit nicht infrage. Er bezweifelt, dass dafür zusätzliche spezielle KI-Gesetze notwendig sind.'
socialmedia:
...
Jensen Huang hat sich deutlich gegen neue Gesetze speziell für künstliche Intelligenz ausgesprochen. Der Gründer und CEO von [Nvidia](https://oliverjessner.at/category/nvidia/) äußerte sich dazu auf der Dreamforce 2026 von Salesforce.

Wie [TechCrunch](https://techcrunch.com/2026/09/15/we-dont-need-ai-regulation-leave-safety-to-us-nvidias-jensen-huang-says/) berichtet, sieht Huang künstliche Intelligenz nicht als grundsätzlich neue oder unkontrollierbare Form von Intelligenz. Für ihn besteht auch moderne KI letztlich aus von Menschen entwickelter Hard- und Software.
...
Aus Sicht des [software-engineering](https://oliverjessner.at/category/software-engineering/) ist der Grundgedanke zunächst nachvollziehbar. Viele Sicherheitsprobleme komplexer Systeme werden tatsächlich technisch behandelt.
...
Huangs Argument überträgt dieses Prinzip auf moderne [KI](https://oliverjessner.at/category/KI/). Auch ein großes Sprachmodell bleibt aus dieser Perspektive ein Computersystem. Es kann getestet, eingeschränkt und überwacht werden.
